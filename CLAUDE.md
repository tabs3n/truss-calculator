...
├── packages/
│   ├── calc-engine/                 ← Claude Code Verantwortung
│   │   ├── src/
...
## Claude Code Verantwortung

Claude Code schreibt und pflegt **ausschließlich** `packages/calc-engine/`.
